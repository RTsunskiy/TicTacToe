...
public class TicTacToeResult implements Parcelable {
        ...
        public TicTacToeResult(int size) {
            if (size <= 0) {
        ...
        protected TicTacToeResult(Parcel in) {
            int size = in.readInt();
        ...
        public static final Creator<TicTacToeResult> CREATOR = new Creator<TicTacToeResult>() {
            @Override
            public TicTacToeResult createFromParcel(Parcel in) {
                return new TicTacToeResult(in);
            }

            @Override
            public TicTacToeResult[] newArray(int size) {
                return new TicTacToeResult[size];
            }
        };
